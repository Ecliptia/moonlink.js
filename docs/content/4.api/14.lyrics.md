...
::stack
  ...
  #description
  Fetches lyrics for the currently playing track. This method takes no direct parameters.
  It returns lyrics data or `null` if no track is playing, if NodeLink is not available, or if no lyrics are found.
  <br>
  <h5>Parameters</h5>
