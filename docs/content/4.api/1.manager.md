...
::stack
  ...
  #description
  Searches for tracks using the configured nodes. The search will be performed on the best available node or a specific node if provided.
  <br>
  <h5>Parameters</h5>
...
Best Practices
  ...
  #description
Follow these guidelines for optimal manager usage:

1. **Initialization**
   - Initialize after Discord client is ready
   - Configure nodes appropriately
   - Handle connection errors
   - Set up proper error handling for events

2. **Node Management**
   - Use multiple nodes for redundancy
   - Configure regions for optimal routing
   - Monitor node health
...
3. **Player Management**
   ...
   - Use appropriate search sources
...
5. **Performance**
  - Use region-based node selection
  - Configure appropriate buffer sizes
   - Monitor memory usage
   - Clean up resources properly

See also:
- [Node Management Guide](/guide/nodes)
- [Player Management Guide](/guide/players)
