...
::stack
  ...
  #description
  Stores a value associated with a key. If the key points to an object and the new value is also an object, they will be merged.
  <br>
  <h5>Parameters</h5>
...
::stack
  ...
  #description
  Clears all data from the database, effectively resetting it.
  <br>
  ::
